...
/// The RustType `FontCollection` type used by splatter.
pub type FontCollection = rusttype::FontCollection<'static>;
/// The RustType `Font` type used by splatter.
pub type Font = rusttype::Font<'static>;
/// The RustType `PositionedGlyph` type used by splatter.
...
where
    ...
    I::IntoIter: 'a,
{
    // Functions for converting splatter coordinates to rusttype pixel coordinates.
