#![doc(
    html_logo_url = "https://raw.githubusercontent.com/splatter-org/splatter/master/assets/images/logo.png"
)]

//! An open-source creative-coding toolkit for Rust.
//!
//! [**splatter**](http://splatter.cc) is a collection of code aimed at making it easy for artists to
...
//! tools they need.
//!
//! If you're new to splatter, we recommend checking out [the
//! examples](https://github.com/splatter-org/splatter/tree/master/examples) to get an idea of how
//! splatter applications are structured and how the API works.
...
#[doc(inline)]
pub use splatter_core::{color, glam, math, rand};
#[doc(inline)]
pub use splatter_mesh as mesh;
#[doc(inline)]
pub use splatter_wgpu as wgpu;
