...
/// A helper type aimed at simplifying the rendering of splatter primitives via wgpu.
#[derive(Debug)]
pub struct Renderer {
...
impl Renderer {
    ...
    pub fn new(
        ...
        let uniform_buffer = device.create_buffer_init(&wgpu::BufferInitDescriptor {
            label: Some("splatter Renderer uniform_buffer"),
            contents,
            usage,
        });
